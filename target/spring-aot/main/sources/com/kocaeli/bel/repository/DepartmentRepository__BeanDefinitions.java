...
public class DepartmentRepository__BeanDefinitions {
  ...
  public static BeanDefinition getDepartmentRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, DepartmentRepository.class, Department.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.kocaeli.bel.repository.DepartmentRepository");
