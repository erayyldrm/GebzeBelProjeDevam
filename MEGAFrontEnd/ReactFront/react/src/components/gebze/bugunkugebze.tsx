                            ...
                            <div className="card-block p-4 md:p-6">
                                ...
                                <div className="text-justify text-gray-700 space-y-4">
                                    <p>
                                        ...
                                        zengin bir tarihi geçmişe sahip, ekonomisi, tarım, hayvancılık ve sanayiye dayalı
                                        ...
                                        bölgesinin en büyük ikinci ilçesi olup Türkiye sanayisinin %15'ini barındırmaktadır.
                                    </p>
                                    ...
                                    <p>
                                        ...
                                        yönünde olması nedeniyle kentsel alanı ve sanayisi bu doğrultuda gelişmiş bir sanayi
                                        bölgesidir.
                                        Gebze ana ulaşım yolları üzerindeki konumu nedeni ile uzun yıllar Anadolu'dan
                                        İstanbul'a göç eden Anadolu halkının, İstanbul'dan önce uğradığı bir ayak olmuştur.
                                    ...
                                    <p>
                                        ...
                                        getirmiştir.
                                        Kentin, limanlara yakınlığının yanında E-5 ve TEM karayollarının birbirine çok yakın
                                        ...
                                        için taşıma kolaylıkları sunması, Türkiye'nin en fazla kalkınmış üç büyük kentinin
                                    ...
                                    <p>
                                        Günümüzde Gebze kara, deniz ve demiryollarının birbirleriyle kesiştiği önemli kavşak
                                        noktasında bulunmaktadır. Eski Gebze şimdiki kasabanın yakınındadır. Yüzeyi
                                        kuzeydoğuda dağ ve sırtlardan, batı güneyde kıyıya yakın bölümlerinde düzlüklerden
                                        ibarettir.
                                        ...
                                        tepelerin en yükseği Gaziler Tepesi'dir. Ancak akarsu yerine dereler ve derecikler
                                        mevcuttur.
                                    </p>

                                    <p>
                                        Genellikle Karadeniz ve Akdeniz bölgeleri arasında bir geçiş özelliği taşımaktadır.
                                        Yaz mevsimi sıcak ve az yağışlı, kış mevsimi oldukça serin ve daha ziyade yağışlı
                                        geçmektedir. Yıllık yağış ortalaması 550 mm. En çok yağış Aralık-Ocak aylarında, en
                                        az yağış ise Ağustos ayındadır. En sıcak ay ortalaması 24.2 derece ile Ağustos ayı,
                                        ...
                                        ekilebilir topraklarında tarım, meyvecilik, sebzecilik ileri bir durumdadır. Marmara
                                        kıyısında ilçe toprakları genellikle ovalıktır.
                                    </p>

                                    <p>
                                        Yoğun sanayi yapılanması ile dikkat çeken Gebze, her ne kadar idari olarak
                                        Kocaeli'ye bağlıysa da, İstanbul iline daha yakın olduğu için, bu ille hem ticari
                                        hem de sosyal ilişkileri gelişmiştir. Uzun yıllar il olması için mücadele edilmiş
                                        olsa da hali hazırda Kocaeli Büyükşehir Belediyesi sınırları içindedir. İstanbul
                                        Büyükşehir Belediyesi, yıllar boyu Gebze'yi kendisine bağlamak istemiş ancak buna
                                        izin verilmemiştir.
                                    ...
                                    <p>
                                        <span className="font-medium">Gebze Organize Sanayi Bölgesi (GOSB)</span>, Gebze merkezine 7 km mesafede 10.370.000
                                        m'lik planlanmış bir alanda, 1985 yılında Gebze ve civarında çarpık sanayileşmenin
                                        yol açtığı çevre kirliliğini önlemek, sanayiyi disipline etmek amacıyla, kredi
                                        kullanmadan, tamamen katılımcıların finansmanı ile kurulmuş ve şu an itibariyle 85
                                        firmada yaklaşık 9100 kişi istihdamı ile faaliyet göstermektedir. GOSB'da bulunan
                                        sanayi yatırımlarının adet olarak %33'ü, yatırım tutarı olarak %65'i yabancı
                                        sermayeli, özellikle de çok uluslu büyük kuruluşlardır. Yurtiçi ve yurtdışı OSB'lere
                                        model olan GOSB da bugün itibari ile makine, kimya, otomotiv yan sanayi, optik,
                                        elektronik, sınai ve tıbbi gaz, gıda ve ambalaj ve bilişim sektöründe üretim yapan
                                    ...
                                    <p>
                                        ...
                                        laboratuvar hizmetleri olarak kalibrasyon, deney, tahribatsız muayene hizmetleri,
                                        ürün ve hizmet yeri belgelendirme dallarında; TSE Uygunluk Belgesi, Kalite Uygunluk
                                        Belgesi (TSEK), İthal Malların Belgelendirilmesi, Araç Proje Hizmetleri, Karayolları
                                        Atık Taşıma Belgesi, Hizmet Yeterlilik Belgelendirmesi(HYB), Laboratuar Yeterlilik
                                        Hizmetleri, Sistem Belgelendirme, TS EN ISO 9000 Kalite Yönetim Sistemi, TS EN ISO
                                        14000 Çevre Yönetim Sistemi, TS EN ISO 22000 HACCP Yönetim Sistemi, TS 18001 OHSAS
                                        Yönetim Sistemi dallarında belgelendirme hizmetleri sunmaktadır.
                                    </p>

                                    <p>
                                        1985 yılında kurulan <span className="font-medium">TÜSSİDE</span>, kamu ve özel sektör kurum ve kuruluşlarında
                                        görev yapan yönetici ve çalışanlarına yönelik olarak; liderlik, motivasyon, etkin
                                        iletişim, takım çalışması, üretim yönetimi, stratejik yönetim, teknoloji yönetimi,
                                        insan kaynakları ve performans yönetimi, temel kalite kavramları ve kurum kültürü,
                                    ...
                                    <p>
                                        ...
                                        sınırları içindeki saygın tek üniversitedir. 1992'de kurulan Gebze Yüksek Teknoloji
                                        ...
                                        donanımıyla, uluslararası diplomalı akademik kadrosuyla ülkemizin en önemli bilim
                                    ...
                                    <p>
                                        <span className="font-medium">TÜBİTAK Marmara Araştırma Merkezi</span> ise, Türkiye'nin küresel rekabet gücünün
                                        artırılmasına bilim ve teknolojiyi kullanarak katkıda bulunmaktadır. Bünyesinde,
                                        Bilişim Teknolojileri Enstitüsü, Enerji Enstitüsü, Yer ve Deniz Bilimleri Enstitüsü,
                                        Malzeme Enstitüsü ve Teknoloji Serbest Bölgesi ve Teknopark İşletmeciliğini yürüten
