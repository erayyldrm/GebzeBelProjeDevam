                                            ...
                                            <div className="col-lg-8 ms-auto">
                                                <div className="card">
                                                    <div className="card-block">
                                                        {/* Image slider */}
                                                        <div className="slider-container" style={{ position: 'relative', width: '100%', height: '450px', overflow: 'hidden' }}>
                                                            {/* Slides */}
                                                            <div className="slides" style={{ display: 'flex', transition: 'transform 0.5s ease', transform: `translateX(-${currentSlide * 100}%)`, width: '100%', height: '100%' }}>
                                                                {slides.map((slide, index) => (
                                                                    <div key={index} style={{ minWidth: '100%', height: '100%' }}>
                                                                        <img
                                                                            src={slide}
                                                                            alt={`Bugunkü Gebze Slide ${index + 1}`}
                                                        ...
                                                        <div style={{ textAlign: 'justify' }}>
                                                            <p>
                                                                ...
                                                                <br/><br/>Gebze, Kocaeli'nin endüstrisinin büyük bölümünü barındıran, Marmara Denizi'nin kuzeyi ile İstanbul'un 45 kilometre doğusunda yer alan bir ilçedir. Marmara bölgesinin en büyük ikinci ilçesi olup Türkiye sanayisinin %15'ini barındırmaktadır.
                                                                ...
                                                                <br/><br/>Gebze ana ulaşım yolları üzerindeki konumu nedeni ile uzun yıllar Anadolu'dan İstanbul'a göç eden Anadolu halkının, İstanbul'dan önce uğradığı bir ayak olmuştur. İstanbul nüfusunun 10 milyonu aşması kentin sorunlarını artırmış, sanayi tesislerinin İstanbul dışında yerleşmesine gereksinim duyulmuştur.
                                                                ...
                                                                <br/><br/>Gebze, Marmara sahiline 7 km., İzmit'e 49 km., İstanbul'a 45 km. uzaklıkta bulunmaktadır. Deniz seviyesinden yüksekliği 130 metredir.

                                                                <br/><br/>Günümüzde Gebze kara, deniz ve demiryollarının birbirleriyle kesiştiği önemli kavşak noktasında bulunmaktadır. Eski Gebze şimdiki kasabanın yakınındadır. Yüzeyi kuzeydoğuda dağ ve sırtlardan, batı güneyde kıyıya yakın bölümlerinde düzlüklerden ibarettir.

                                                                <br/><br/>İlçe sınırları içinde, göl ,dağ, akarsu bulunmamakla beraber, yaklaşık 650 metre yüksekliği geçmeyen tepelerin ve sırtların varlığından söz edilebilmektedir. Bu tepelerin en yükseği Gaziler Tepesi'dir. Ancak akarsu yerine dereler ve derecikler mevcuttur.

                                                                <br/><br/>Genellikle Karadeniz ve Akdeniz bölgeleri arasında bir geçiş özelliği taşımaktadır. Yaz mevsimi sıcak ve az yağışlı, kış mevsimi oldukça serin ve daha ziyade yağışlı geçmektedir. Yıllık yağış ortalaması 550 mm. En çok yağış Aralık-Ocak aylarında, en az yağış ise Ağustos ayındadır. En sıcak ay ortalaması 24.2 derece ile Ağustos ayı, en soğuk ay ortalaması 6.5 derece ile Ocak ayıdır.

                                                                <br/><br/>Gebze'nin Körfez şeridi üzerindeki yerleşim yerlerinde, tabiatın oluşturduğu birbirinden güzel koyları ve tabii plajları ile çekici düzeydedir. Yörenin ekilebilir topraklarında tarım, meyvecilik, sebzecilik ileri bir durumdadır. Marmara kıyısında ilçe toprakları genellikle ovalıktır.
