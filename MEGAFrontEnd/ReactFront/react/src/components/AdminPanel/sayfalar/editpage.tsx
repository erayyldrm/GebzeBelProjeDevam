...
const EditPageForm: React.FC<EditPageFormProps> = () => {
    ...
    const handleSave = async () => {
        ...
        if (!formData.title.trim()) {
            alert('Sayfa başlığı gerekli');
            return;
        }

        if (!formData.slug.trim()) {
            alert('Sayfa slug\'ı gerekli');
            return;
        }
        ...
        try {
            // Check if this is a converted entity that cannot be edited via PageAPI
            if (page.id > 10000) {
                        ...
                        <div className="p-6">
                            ...
                            <div className="prose max-w-none">
                                ...
                                <div className="text-gray-700 leading-relaxed whitespace-pre-wrap">
                                    {formData.content || 'İçerik henüz eklenmemiş...'}
                                </div>
                            </div>
                        </div>
                    )}
