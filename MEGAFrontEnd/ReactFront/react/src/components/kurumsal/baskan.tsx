                                                ...
                                                <div className="card">
                                                    <div className="card-block">
                                                        <div className="d-flex align-items-center mb-3">
                                                            <img src="/images/kurumsal/baskansayfasi.jpg" style={{ width: '100%', height: '100%' }} alt="Zinnur Büyükgöz" className="baskan-resim" />
                                                        </div>
                                                        ...
                                                        <div className="d-flex justify-content-between align-items-center">
                                                            <div className="social-icons d-flex align-items-center">
                                                                <a href="https://www.facebook.com/zinnurbuyukgoz" target="_blank" rel="noopener noreferrer" className="me-2">
                                                                ...
                                                                <a href="https://x.com/zinnurbuyukgoz" target="_blank" rel="noopener noreferrer" className="me-2">
                                                                ...
                                                                <a href="https://www.instagram.com/zinnurbuyukgoz/" target="_blank" rel="noopener noreferrer">
                                                            ...
                                                            <img src="/images/kurumsal/imza.png"
                                                                 style={{width: '200px', height: '200px'}} alt="imza"
                                                                 className="imza"/>
                                                        </div>
                                                    </div>
                                                </div>
