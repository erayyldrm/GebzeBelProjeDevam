        ...
        <footer className="bg-[#022842] text-white py-10 rounded-t-[16px]">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="px-4">
                    ...
                    <p className="text-justify">Gebze Belediyesi, ilçenin sürdürülebilir gelişimi için modern ve kaliteli hizmetler sunar.</p>
                </div>
                ...
                <div className="px-4">
                    ...
                    <ul className="d-flex gap-3 list-unstyled">
                        ...
                        <li>
                            <a href="https://www.facebook.com/gebzebelediye" target="_blank" rel="noopener noreferrer" className="text-white">
                        ...
                        <li>
                            <a href="https://www.instagram.com/gebze_belediyesi/#" target="_blank" rel="noopener noreferrer" className="text-white">
                        ...
                        <li>
                            <a href="https://twitter.com/gebze_belediyesi" target="_blank" rel="noopener noreferrer" className="text-white">
                        ...
                        <li>
                            <a href="https://www.youtube.com/channel/UCj2OaUgzp76dOS2jTlz2frg" target="_blank" rel="noopener noreferrer" className="text-white">
