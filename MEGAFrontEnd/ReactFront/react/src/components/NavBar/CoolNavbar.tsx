        ...
        >
            <div className="max-w-full mx-auto px-4">
                <div className="flex justify-between h-35">
                    ...
                    <div ref={dropdownRef} className="sm:hidden md:flex md:items-center md:justify-between">
                        {/* Main navbar items */}
                        <div className="flex gap-8 ">
                            ...
                            <a href="/haberler" className="inline-flex items-center px-1 pt-1 text-lg font-medium text-white">
                                Haberler
                            </a>
