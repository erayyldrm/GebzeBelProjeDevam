...
const documents = [
    { name: "Çoban Mustafa Paşa Külliyesi 1", url: "/proje.pdf" },
    { name: "Çoban Mustafa Paşa Külliyesi 2", url: "/yatirim.pdf" },
    { name: "Fatih Sultan Mehmed Dönemi Ferman Ve Arşivleri", url: "/altyapi.pdf" },
];
