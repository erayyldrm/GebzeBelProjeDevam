...
const Sidebar: React.FC<SidebarProps> = ({ items, title, autoCollapseWidth = 1024 }) => {
    ...
    return (
        <div
            className={`lg:block ${collapsed ? 'w-16' : 'w-72'} hidden shadow-lg rounded-2xl md:h-150 md:relative md:top-10 md:left-13 md:z-10 md:overflow-hidden md:transition-all duration-300`}
            style={{
