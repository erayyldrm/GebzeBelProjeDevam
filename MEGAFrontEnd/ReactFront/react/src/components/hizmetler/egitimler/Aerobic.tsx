...
const Aerobic: React.FC<ServiceDetailProps> = ({
                                                      title = "STEP AEROBİK",
                                                      description = "",
                                                      imageUrl = "",
                                                      address = "",
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">VERİLEN HİZMETLER
                                ...
                                <br/>
                                Cumhuri̇yet Mah Cumhuriyet, Yeni Bağdat Cd. No:117, 41400 Gebze/Kocaeli Gebze / KOCAELİ
                                <br/>
                                +90 262 641 24 93

                                <br/>
                                <br/>
                                İSTASYON BİLİM VE SANAT MERKEZİ
<br/>
                                İstasyon Mah İstasyon Mahallesi Şehit Abdullah Horoz Caddesi No:26 Gebze / KOCAELİ
                        ...
                        >
                            Detaylı Bilgi ve Kayıt Linki İçin Tıklayınız
                        </a>
                        {/* Atölyeler */}
