                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">Aile Danışmanlık Merkezi alanında uzman ve deneyimli psikolog kadrosu ile 2016 Aralık ayından itibaren tüm Gebze halkına ücretsiz hizmet vermektedir. Merkezde, evlilik öncesi, evlilikte yaşanan ilişki sorunları ve boşanma dönemi ve sonrası süreçlerde çiftlere destek sağlanmaktadır.
                                <br/>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700"> 0262 641 11 82 {phone}</p>
                                </div>
                                <br />
                                <div className="flex items-center">
