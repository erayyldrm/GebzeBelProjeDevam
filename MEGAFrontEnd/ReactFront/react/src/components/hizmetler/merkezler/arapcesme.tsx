                ...
                <div className="flex flex-col gap-4">
                    ...
                    <section className="text-justify space-y-4">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                            Merkezimizde çocuk ve yetişkinlere yönelik kurslarımız bulunmaktadır branşlarımız; jimnastik, masa tenisi, satranç, okçuluk, zeka oyunları, bağlama, resim ve ebru. Gesmek yetişkin branşları; ofis programları, i̇ngilizce, iğne oyası, el nakışı, mefruşat, dikiş, takı tasarım ve step aerobik. Destek eğitim derslerimiz; i̇ngilizce, matematik, fen bilimleri, türkçe. Ayrıca haftanın belli günlerinde çocuk pedagogumuz da mevcuttur..</p>
                    </section>
