                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">Gebze ve çevresindeki il ve ilçelerde yaşayan vatandaşlarımıza binicilik branşın’da binicilik eğitimleri vermek, gezintiler, çeşitli projeler ve sosyal etkinliklerle bireyleri binicilik sporu ile tanıştırmaktayız.
                                <br/>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <p className="text-gray-700">
                                        GAZİLER MAH.1793 SOK. NO: 58 KOCAELİ/GEBZE{" "}
                                        {address}
                                    </p>
                                </div>
                                <br />
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700"> 0262 642 66 90 {phone}</p>
                                </div>
                                <br />
                                <div className="flex items-center">
