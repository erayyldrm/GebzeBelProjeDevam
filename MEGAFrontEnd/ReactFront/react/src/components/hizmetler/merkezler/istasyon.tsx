                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">MERKEZİMİZDE ÇOCUK VE YETİŞKİNLERE YÖNELİK KURSLARLARIMIZ BULUNMAKTADIR. GESMEK ÇOCUK 7-14 YAŞ ARASI BRANŞLARIMIZ; DRAMA, RESİM, EBRU, MASA TENİSİ, JİMNASTİK, SATRANÇ, ZEKA OYUNLARI, BAĞLAMA.
<br/>
                                ...
                                <br/>
                                GESMEK YETİŞKİN 18 YAŞ ÜZERİ; OFİS PROGRAMLARI, İĞNE OYASI, EL NAKIŞI,MEFRUŞAT, DİKİŞ, TAKI TASARIM,ZUMBA.
                            </p>  </section>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700"> 0262 655 25 54{phone}</p>
                                </div>
                                <br />
                                <div className="flex items-center">
                                    <Clock className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" />
                                    <p className="text-gray-700">09:00 - 18:00 {workingHours}</p>
                                </div>
                            </div>
                        </div>
                    </div>
