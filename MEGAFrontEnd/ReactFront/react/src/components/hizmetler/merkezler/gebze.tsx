                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">GEBZE KÜLTÜR MERKEZİ; KÜLTÜR, SANAT, SPOR, SAĞLIK GİBİ BİR ÇOK ALANDA 7'DEN 70'E HER KESİME HİTAP EDEN ÜCRETSİZ PROGRAMLARIMIZLA HİZMET VERMEKTEDİR. AYRICA GKM SALONUMUZ VE KARDELEN SALONUMUZ KAMU KURUM VE KULUŞLARA ÜCRET KARŞILIĞINDA TAHSİS EDİLMEKTEDİR.
                            </p>  </section>
