...
const Hayvan: React.FC<ServiceDetailProps> = ({
                                                title = "SOKAK HAYVANLARI TEDAVİ, REHABİLİTASYON VE EĞİTİM MERKEZİ",
                                                description = "",
                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">Veteriner İşleri Müdürlüğü bünyesinde bulunan Sokak Hayvanları Tedavi, Rehabilitasyon ve Eğitim Merkezimiz, ilçemizin sahipsiz sokak hayvanlarına 7/24 esaslı çalışma prensibi ile hizmet etmektedir.
<br/>
                                Merkezimizde sahipsiz sokak hayvanlarımıza hizmet için; 3 hayvan refah ekibi, 1 adet mobil klinik (acil durum müdahale aracı), 3 alanında uzman Veteriner Hekim, 12 Destek ve yardımcı personel, donanımlı bir ameliyathane, muayenehane, laboratuvar, yoğun bakım üniteleri, müşahede bölümü bulunmaktadır. Ayrıca Merkezimizde İlk Orta ve Lise düzeyi öğrencilerimiz için Eğitim Salonu mevcut olup hayvan sevgisi, zoonoz hastalıklar, hijyen ve Veteriner Hekimlik mesleği ile ilgili yıl boyunca eğitimler ve seminerler düzenlenmektedir.
                            </p>  </section>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <p className="text-gray-700">
                                        Pelitli Mahallesi Yeni Mezarlık Yolu Caddesi No:49 Gebze Kocaeli{" "}
                                        {address}
                                    </p>
                                </div>
                                <br />
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700">0262 642 04 30{phone}</p>
                                </div>
                                <br />
                                <div className="flex items-center">
