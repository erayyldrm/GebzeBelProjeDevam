                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <section className="flex-1 text-justify space-y-4">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                            Veteriner İşleri Müdürlüğü bünyesinde bulunan Sokak Hayvanları Tedavi, Rehabilitasyon ve Eğitim Merkezimiz, ilçemizin sahipsiz sokak hayvanlarına 7/24 esaslı çalışma prensibi ile hizmet etmektedir.
<br/>
                        ...
                        <div className="bg-blue-50 rounded-lg p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700">0262 642 04 30
                                        {phone}</p>
                                </div>
                                <div className="flex items-center">
                                    <Mail className="w-5 h-5 text-blue-600 mr-3 flex-shrink-0" />
                                    <p className="text-gray-700">veteriner@gebze.bel.tr</p>
                                </div>
                                <br />
