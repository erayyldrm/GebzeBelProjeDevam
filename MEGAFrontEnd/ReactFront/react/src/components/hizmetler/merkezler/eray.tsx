...
const Eray: React.FC<ServiceDetailProps> = ({
                                                title = "ERAY ŞAMDAN SPOR SALONU",
                                                description = "",
                ...
                <div className="mb-8 text-center text-blue-800">
                    ...
                    <div className="flex justify-center">
                        <div className="relative h-[500px] sm:h-[600px] md:h-[750px] lg:h-[850px] w-[90%] sm:w-3/4 md:w-2/3 lg:w-2/3 rounded-lg overflow-hidden shadow-lg">
                            <img
                                src="/images/hizmetler/merkezler/eray.jpg"
                                alt={title}
                ...
                <div className="flex flex-col md:flex-row gap-5">
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base">Tesisimizde 1 adet spor salonu, cimnastik, okçuluk ve masa tenisi salonları da bulunmaktadır.
<br/>
                                Spor salonumuzda yaz ve kış olmak üzere iki dönemde birçok spor branşında eğitim verilmektedir.
                                <br/>
                                Salonumuzda okul müsabakalarına da ev sahipliği yapmaktadır.
                                <br/>
                                Salonumuzun uygunluğuna göre vatandaşlarımızın ücretsiz olarak spor faaliyetleri yapmalarında imkân sağlanmaktadır.
                                <br/>
                                BRANŞLAR:
                                <br/>
                                Basketbol
