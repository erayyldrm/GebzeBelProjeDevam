                ...
                <div className="flex flex-col gap-4">
                    ...
                    <section className="text-justify space-y-4">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                            Merkezimizde 7-14 yaş arası destek eğitim derslerimiz bulunmaktadır. Branşlarımız; türkçe, matematik, i̇ngilizce, sosyal bilgiler, doğa ve fen bilimleri. Sanat branşlarımız; drama, ebru, resim, bağlama, satranç, zeka oyunları. Gesmek yetişkin kurslarımız; ofis programları, iğne oyası, el nakışı, mefruşat, dikiş. Yetişkin okuma yazma programı kapsamında yetişkinlere okur-yazarlık dersleri verilmektedir. İlkokul ve ortaokul öğrencilerine yönelik psikolojik danışmanlık hizmetimiz de mevcuttur.</p>
                    </section>
