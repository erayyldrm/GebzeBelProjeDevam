                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <section className="flex-1 text-justify space-y-4">
                        ...
                        <p className="text-gray-700 text-sm leading-relaxed">
                            MERKEZİMİZDE 7-14 YAŞ ARASI DESTEK EĞİTİM DERSLERİMİZ BULUNMAKTADIR. BRANŞLARIMIZ; TÜRKÇE, MATEMATİK, İNGİLİZCE, SOSYAL BİLGİLER, DOĞA VE FEN BİLİMLERİ.SANAT BRANŞLARIMIZ; DRAMA, EBRU, RESİM, BAĞLAMA, SATRANÇ, ZEKA OYUNLARI.GESMEK YETİŞKİN KURSLARIMIZ; OFİS PROGRAMLARI, İĞNE OYASI, EL NAKIŞI,MEFRUŞAT, DİKİŞ.YETİŞKİN OKUMA YAZMA PROGRAMI KAPSAMINDA YETİŞKİNLERE OKUR-YAZARLIK DERSLERİ VERİLMEKTEDİR.İLKOKUL VE ORTAOKUL ÖĞRENCİLERİNE YÖNELİK PSİKOLOJİK DANIŞMANLIK HİZMETİMİZDE MEVCUTTUR.</p>
                    </section>
