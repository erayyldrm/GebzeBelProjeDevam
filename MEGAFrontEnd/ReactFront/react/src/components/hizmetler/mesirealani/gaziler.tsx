...
const Gaziler: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("http://localhost:8080/api/hizmetler/geridonusum/29");
                if (!response.ok) {
            ...
            <div className="w-full max-w-5xl mx-auto">
                <div className="relative w-full aspect-[16/9] rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
                        ...
                        <a
                            href="https://www.google.com/maps/dir//Gaziler,+Dicle+Cd.+No:48,+41400+Gebze%2FKocaeli/@40.83049,29.3447269,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x14cb21e3f92f3d03:0xf3e8a2e6ff3f0764!2m2!1d29.4271277!2d40.8305193?hl=tr&entry=ttu"
                            target="_blank"
