...
const Cumakoy: React.FC = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch("http://localhost:8080/api/hizmetler/geridonusum/28");
                if (!response.ok) {
            ...
            <div className="w-full max-w-5xl mx-auto">
                <div className="relative w-full aspect-[16/9] rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-center px-4">
                        ...
                        <a
                            href="https://www.google.com/maps/dir//Cumak%C3%B6y,+41400+Gebze%2FKocaeli"
                            target="_blank"
