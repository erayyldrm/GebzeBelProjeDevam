...
const Beylikbilim: React.FC<ServiceDetailProps> = ({
                ...
                <div className="mb-8 text-center text-blue-800">
                    ...
                    <div className="flex justify-center">
                        <div className="relative h-[500px] sm:h-[600px] md:h-[750px] lg:h-[850px] w-[90%] sm:w-3/4 md:w-2/3 lg:w-2/3 rounded-lg overflow-hidden shadow-lg">
                            <img
                                src="/images/hizmetler/kütüphane/beylikbagıbilim.jpg"
                                alt={title}
                    ...
                    <div className="md:w-2/3 w-full">
                        <section>
                            ...
                            <p className="text-gray-700 mb-4 text-sm sm:text-base"> <br/>
                                Beylikbağı Bilim ve Sanat Merkezi Kütüphanemiz Haftaiçi ve Haftasonu 09:00/21:00 saatleri arasında her gün tüm halkımıza açıktır.
<br/>
                        ...
                        <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <p className="text-gray-700">0262 642 18 95
                                        {phone}</p>
                                </div>
                                <br />
